...
function loadServicesSwiper() {
  ...
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.services-swiper', {
    ...
    on: {
      slideChange: () => {
        fraction.innerHTML = `<span class="fraction services__fraction-item">0${swiper.realIndex + 1}</span> <span class="fraction services__fraction-item">0${slideCount}</span>`;
      }
    }
  });
}
...
function formValidation(form) {
  ...
  let phone = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  let check = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
  // PHONE MASK
...
/* harmony export */   focusServicesCard: () => (/* binding */ focusServicesCard),
/* harmony export */   removeClass: () => (/* binding */ removeClass),
/* harmony export */   smoothHeight: () => (/* binding */ smoothHeight)
/* harmony export */ });
...
function showModal() {
  ...
  (0,_form_validation__WEBPACK_IMPORTED_MODULE_1__.formValidation)('modal-form', 'modal-form-name', modalPhone, 'modal-form-check');
